...
console.log('--------------------------------- LCL -------------------');
//var LCL = localStorage.<?php echo $_SESSION["PROJECT"];?> ;
// console.log(LCL);
// window.localStorage['<?php echo $_SESSION["PROJECT"];?>'] = "toto";
var LCL = window.localStorage['<?php echo $_SESSION["PROJECT"];?>'];
console.log(LCL);
// console.log(localStorage.1_aufildeleau);
console.log('--------------------------------- LCL -------------------');
